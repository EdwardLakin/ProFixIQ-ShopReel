...
export function RuntimeEnvironmentField({ chamber, intelligence }: { chamber: RuntimeChamberGeometry; intelligence: RuntimeEnvironmentalIntelligence }) {
  ...
  return <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
    <div className="absolute inset-0" style={{ background: `radial-gradient(120% 68% at ${50 + intelligence.continuityPressure * 6}% 100%, rgba(56,189,248,${0.08 + intelligence.atmosphericDensity * 0.2}), transparent ${70 + intelligence.silhouetteDistance * 10}%)` }} />
    <div className="absolute inset-0" style={{ background: `linear-gradient(${180 + intelligence.orchestrationFragmentation * 3}deg, rgba(8,13,25,${0.28 + intelligence.environmentalAttenuation * 0.2}), rgba(8,13,25,${0.46 + intelligence.spatialFog * 0.3}) 50%, rgba(2,6,23,0.9))` }} />
