...
export const GEOMETRY_BY_WORLD: Record<RuntimeWorldId, RuntimeChamberGeometry> = {
  ...
  idea: { identity: "idea", chamberWidth: 1.22, chamberHeight: 1.04, directionalBias: { x: 0.16, y: -0.05, z: 0.18 }, depthProfile: { foreground: 0.9, midground: 0.68, background: 0.44, peripheral: 0.34, atmosphere: 0.2 }, anchorMap: { operator: "south-east", foreground: "north", manual: "center" }, backdrop: { horizonGlow: 0.66, fogDensity: 0.3, silhouetteDepth: 0.5, volumetricBands: 4 }, motionLanguage: { axis: "orbital", easing: "guided", drift: 0.24 } },
  ...
  video_creation: { identity: "video_creation", chamberWidth: 1.18, chamberHeight: 1, directionalBias: { x: 0.2, y: -0.06, z: 0.22 }, depthProfile: { foreground: 0.92, midground: 0.7, background: 0.4, peripheral: 0.32, atmosphere: 0.2 }, anchorMap: { operator: "south-east", foreground: "north", manual: "east" }, backdrop: { horizonGlow: 0.58, fogDensity: 0.28, silhouetteDepth: 0.48, volumetricBands: 4 }, motionLanguage: { axis: "forward", easing: "elastic", drift: 0.24 } },
  calendar: { identity: "calendar", chamberWidth: 1.2, chamberHeight: 1.02, directionalBias: { x: 0.1, y: -0.08, z: 0.14 }, depthProfile: { foreground: 0.88, midground: 0.66, background: 0.46, peripheral: 0.36, atmosphere: 0.22 }, anchorMap: { operator: "north-east", foreground: "center", manual: "west" }, backdrop: { horizonGlow: 0.62, fogDensity: 0.24, silhouetteDepth: 0.52, volumetricBands: 4 }, motionLanguage: { axis: "lateral", easing: "settle", drift: 0.16 } },
  automation: { identity: "automation", chamberWidth: 1.1, chamberHeight: 0.94, directionalBias: { x: -0.1, y: -0.06, z: 0.18 }, depthProfile: { foreground: 0.9, midground: 0.68, background: 0.4, peripheral: 0.3, atmosphere: 0.18 }, anchorMap: { operator: "north-west", foreground: "center", manual: "center" }, backdrop: { horizonGlow: 0.46, fogDensity: 0.28, silhouetteDepth: 0.46, volumetricBands: 4 }, motionLanguage: { axis: "forward", easing: "guided", drift: 0.14 } },
