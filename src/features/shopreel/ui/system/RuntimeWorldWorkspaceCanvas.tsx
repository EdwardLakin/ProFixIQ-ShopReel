...
export default function RuntimeWorldWorkspaceCanvas({ entry, children, operatorPanel, panelReveal, continuityRailFocus }: { entry: RuntimeWorldEntry; children: ReactNode; operatorPanel: ReactNode; panelReveal: number; continuityRailFocus: number }) {
  ...
  return <section className={`grid gap-4 ${railClass}`} style={{ opacity: Math.max(0.82, panelReveal) }}>
