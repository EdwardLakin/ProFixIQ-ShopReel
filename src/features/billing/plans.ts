...
export const BILLING_PLANS: Record<BillingPlan, PlanConfig> = {
  starter: {
    ...
    description: "For solo operators building a controlled content workflow.",
    bestFor: "Best for proving the operating loop: ideas, manual creation, review, and export packages.",
  ...
  growth: {
    ...
    description: "For teams running weekly multi-channel content production.",
    bestFor: "Best for consistent campaign production, video workflows, asset analysis, and performance learning.",
    badge: "Most popular",
  ...
  unlimited: {
    ...
    description: "For teams building continuous AI-native content operations.",
    bestFor: "Best for high-volume production systems, recurring content loops, priority workflows, and team-scale execution.",
