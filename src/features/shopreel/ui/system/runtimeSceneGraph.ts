...
export function buildRuntimeSceneComposition(params: {
  ...
  const nodes: RuntimeSceneNode[] = [
    { id: "atmosphere", plane: "atmosphere", depth: params.chamber.depthProfile.atmosphere, anchor: "center", vector: { x: 0, y: 0, z: -0.2 }, scale: 1.06, opacity: 0.9, blur: 0, focusPriority: 0.1, pointerEvents: "none", content: params.atmosphere },
    { id: "background", plane: "background", depth: params.chamber.depthProfile.background, anchor: "center", vector: { x: shift.x * 0.2, y: shift.y * 0.2, z: -0.1 }, scale: 1.01, opacity: 0.76, blur: 0.2, focusPriority: 0.2, pointerEvents: "none", content: params.background },
    { id: "peripheral", plane: "peripheral", depth: params.chamber.depthProfile.peripheral, anchor: "east", vector: { x: shift.x * 0.3, y: 0, z: -0.08 }, scale: 0.98, opacity: 0.86, blur: 0.1, focusPriority: 0.3, pointerEvents: "auto", content: params.peripheral },
    { id: "midground", plane: "midground", depth: params.chamber.depthProfile.midground, anchor: params.chamber.anchorMap.manual === "west" ? "west" : params.chamber.anchorMap.manual === "east" ? "east" : "center", vector: { x: shift.x * 0.5, y: shift.y * 0.35, z: shift.z * 0.45 }, scale: 1, opacity: 1, blur: 0, focusPriority: params.traversal.arrivalFocusPlane === "midground" ? 1 : 0.7, pointerEvents: "auto", content: params.midground },
    { id: "operator", plane: "operator", depth: params.chamber.depthProfile.foreground, anchor: params.chamber.anchorMap.operator, vector: { x: shift.x * 0.42, y: shift.y * 0.5, z: shift.z * 0.55 }, scale: 0.96, opacity: 0.96, blur: 0, focusPriority: params.traversal.arrivalFocusPlane === "operator" ? 0.98 : 0.72, pointerEvents: "auto", content: params.operator },
    { id: "foreground", plane: "foreground", depth: params.chamber.depthProfile.foreground, anchor: params.chamber.anchorMap.foreground === "north" ? "north" : params.chamber.anchorMap.foreground === "south" ? "south" : "center", vector: { x: shift.x * 0.65, y: shift.y * 0.7, z: shift.z * 0.8 }, scale: 1.02, opacity: 1, blur: 0, focusPriority: params.traversal.arrivalFocusPlane === "foreground" ? 1 : 0.84, pointerEvents: "auto", content: params.foreground },
  ];
