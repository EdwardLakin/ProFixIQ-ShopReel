...
const PLAN_ORDER: BillingPlan[] = ["starter", "creator", "pro"];
  ...
  return (
    <section className="mx-auto w-full max-w-7xl px-6 py-24">
      <div className="mx-auto max-w-3xl text-center">
        <div className={cx("text-sm uppercase tracking-[0.28em]", glassTheme.text.copperSoft)}>
          Pricing
        </div>
        <h2 className={cx("mt-4 text-4xl font-semibold md:text-5xl", glassTheme.text.primary)}>
          Every plan includes every feature
        </h2>
        <p className={cx("mt-4 text-base leading-7 md:text-lg", glassTheme.text.secondary)}>
          ShopReel scales by output volume, not by locking features behind higher tiers.
        </p>
      </div>
      ...
      <div className="mt-12 grid gap-5 lg:grid-cols-3">
        {PLAN_ORDER.map((planKey) => {
          ...
          const highlight = plan.key === "creator";
